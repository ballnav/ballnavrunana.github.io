...
from running_phase import RunningGaitCycleCounter
...
def process_video(video_path, output_dir="data"):
    ...
    if total_frames > 0:
        ...
        res_total = evaluate_each_body_sum(sum_total, (70, 100))
        res_acc_trunk = evaluate_each_body_sum(acc_trunk_lean, (70, 100))
        res_acc_front_knee = evaluate_each_body_sum(acc_front_knee_angle, (70, 100))
        res_acc_back_knee = evaluate_each_body_sum(acc_back_knee_angle, (70, 100))
        res_acc_hip = evaluate_each_body_sum(acc_front_hip_angle, (70, 100))
        res_acc_each = evaluate_each_body_sum(avg_angle_each_body, (70, 100))
